...
Note: Troles is a full redesign of roles generic and company, using lessons learned and using a much cleaner/test driven design from the start. It is aimed at being easy to extend and easy to create adapters for etc.
...
The specs now validate that caching is in place and works as expected.
