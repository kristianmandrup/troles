...
There is now also a global ORM configuration options for troles, so you can do sth. like:

@Troles::Common::Config.default_orm = :mongoid@

Troles uses this setting in case you don't specify the orm when you configure a troles strategy.
