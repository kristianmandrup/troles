...
I have just started using "Yard":http://rubydoc.info/docs/yard/file/docs/GettingStarted.md for documentation.
Nice :)

There is now support for Caching and invalidation of the role_list when the roles change. The specs now validate that caching is in place and works as expected (using rspec expectations!)
