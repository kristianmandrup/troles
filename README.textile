...
Using naming conventions it will use a storage class of the form: _Troles::Storage::EncryptedStringMany_ in the example below (substitute Strategy for Storage). 
