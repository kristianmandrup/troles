  ...
  class Config
    module Schema
      class BaseModel
        ...
        # gets the key of a given model type
        # TODO: pull in from Models class?
        def key type
          models.key type
        end                
        ...
        def through_options class_name
          through_option.merge(source_option class_name).merge(class_name_option class_name) #.merge(foreign_key_option class_name)
        end
