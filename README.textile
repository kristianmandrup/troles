...
Updated to use the latest _sugar-high_ and _sweetloader_ gems. Also fixed most specs so they pass again. 
In generela, troles should now be working with respect to the API and various implementation strategies. 
